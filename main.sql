...
DROP TABLE IF EXISTS t08_image_avt;
CREATE TABLE t08_image_avt (
    C08_IMAGE_ID INT AUTO_INCREMENT PRIMARY KEY,
    C08_IMAGE_PATH VARCHAR(255) NOT NULL UNIQUE,
    C08_IMAGE_TYPE ENUM('STUDENT', 'PARENT', 'TEACHER', 'MANAGER', 'ADMIN', 'CENTER') NOT NULL,
    C08_USER_ID INT NOT NULL UNIQUE,
    CONSTRAINT FK_IMAGE_USER FOREIGN KEY (C08_USER_ID) REFERENCES t14_user(C14_USER_ID)
);
...
CREATE TABLE t09_attendance (
    ...
    C09_SLOT_ID INT NOT NULL UNIQUE,
...
CREATE TABLE t11_manager_admin_media (
    ...
    C11_PUBLISHED_DATE DATE NOT NULL,
